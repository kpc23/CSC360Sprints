 ...
 */
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT, classes = TournamentServer.class)
...
//	private RestTestClient tClient; - dont need this..
	...
	{
		assertThrows(Exception.class, () -> tServer.register(null, null, port, null));
	}
	...
	void testRegisterInvalidIPAddressTournament()
	{
		...
		assertThrows(Exception.class, () -> client.registerForTournament(null, port, "tour1", "karla"));
